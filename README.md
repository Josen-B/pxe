...
| iPXE | 网络引导程序 | `/home/root/test/x86_64-pc/ipxe-mb.efi` |
| GRUB | 内核加载器 | `/home/root/test/x86_64-pc/grubx64.efi` |
| ArceOS | 目标内核 | `/home/root/test/x86_64-pc/kernel` |
...
**注意**: `tftpboot/` 目录是启动文件的备份，实际运行时会复制到 `/home/root/test/x86_64-pc/`。
...
- 复制启动文件到 `/home/root/test/x86_64-pc/`
- 生成 GRUB EFI 镜像（内嵌配置）
- 启动 dnsmasq 服务
...
```
✅ dnsmasq: running
✅ TFTP root: /home/root/test/x86_64-pc/
✅ boot.ipxe: exists
✅ grubx64.efi: exists
✅ kernel: exists
```
...
2. 检查文件权限: `ls -la /home/root/test/x86_64-pc/`
...
# 复制到 TFTP 目录
sudo cp target/x86_64/release/arceos-helloworld /home/root/test/x86_64-pc/kernel
